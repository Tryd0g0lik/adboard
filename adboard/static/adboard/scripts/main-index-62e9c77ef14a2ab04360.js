...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   handlerUserForm: () => (/* binding */ handlerUserForm)\n/* harmony export */ });\n/* harmony import */ var src_adboard_scripts_services_taskGetErrorContent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/adboard/scripts/services/taskGetErrorContent */ \"./src/adboard/scripts/services/taskGetErrorContent.ts\");\n/* harmony import */ var src_scripts_validators_validateLength__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/scripts/validators/validateLength */ \"./src/scripts/validators/validateLength.ts\");\n/* harmony import */ var src_scripts_validators_validateRegex__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/scripts/validators/validateRegex */ \"./src/scripts/validators/validateRegex.ts\");\n/* harmony import */ var _ENV__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ENV */ \"./dotenv__.ts\");\n/* harmony import */ var src_scripts_cookies_setCookies__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/scripts/cookies/setCookies */ \"./src/scripts/cookies/setCookies.ts\");\n/**\r\n * src\\adboard\\scripts\\handlers\\handlerFormUsers\\handlerRegisterForm.ts\r\n */\n\n\n\n\n\n\n/***\r\n * Function that handle user's forms. It is the registration form and login form.\r\n * @param: event: KeyboardEvent ('to the 'Enter'keydown')\r\n */\nasync function handlerUserForm(event) {\n  var _document$querySelect;\n  console.log('REGISTER FORM');\n  if (!event.key || event.key && event.key.toLowerCase() !== \"enter\") {\n    return;\n  }\n  ;\n  const pathname = location.pathname;\n  // GET DATA FROM FORM\n  const body_ = {};\n  // body_.method = \"GET\";\n  const currentTarget = event.currentTarget;\n  const formHtml = currentTarget.querySelector(\"form\");\n  const form = new FormData(formHtml);\n\n  // PREVENT DEFAULT\n  event.preventDefault();\n  event.stopPropagation();\n\n  // SEND DATA TO API\n  body_.method = \"POST\";\n  body_.body = form;\n  // CHECK VALIDITY USERNAME\n  const title = form.get('username').trim();\n  const regexUsername = /(^[a-zA-Z][a-zA-Z_0-9]{2,29}$|^$)/;\n  const regexEmail = /(^[a-zA-Z0-9]{3,50}@{1}[a-zA-Z]{2,30}\\.[a-zA-Z]{2,5}$|^$)/;\n  (_document$querySelect = document.querySelector(\".invalid\")) === null || _document$querySelect === void 0 || _document$querySelect.remove();\n  try {\n    // VALIDATE TITLE AD\n    await Promise.all([(0,src_scripts_validators_validateLength__WEBPACK_IMPORTED_MODULE_1__.validateMinLength)(title, 3), (0,src_scripts_validators_validateLength__WEBPACK_IMPORTED_MODULE_1__.validateMaxLength)(title, 30), (0,src_scripts_validators_validateRegex__WEBPACK_IMPORTED_MODULE_2__.validateRegex)(title, regexUsername)]);\n  } catch (err) {\n    const fieldHTML = currentTarget.querySelector('input[name=\"username\"]');\n    (0,src_adboard_scripts_services_taskGetErrorContent__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(fieldHTML, err);\n    return;\n  }\n  ;\n  const email = form.get('email');\n  if (email && email.includes(\"@\") || (typeof form.get('email')).includes(\"string\") && form.get('email').length == 0) {\n    try {\n      // VALIDATE EMAIL\n      const email = form.get('email').trim();\n      await Promise.all([(0,src_scripts_validators_validateLength__WEBPACK_IMPORTED_MODULE_1__.validateMinLength)(email, 3), (0,src_scripts_validators_validateLength__WEBPACK_IMPORTED_MODULE_1__.validateMaxLength)(email, 50), (0,src_scripts_validators_validateRegex__WEBPACK_IMPORTED_MODULE_2__.validateRegex)(email, regexEmail)]);\n    } catch (err) {\n      const fieldHTML = currentTarget.querySelector('input[name=\"email\"]');\n      (0,src_adboard_scripts_services_taskGetErrorContent__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(fieldHTML, err);\n      return;\n    }\n  }\n  ;\n\n  // CHECK VALIDITY PASSWORD\n  const password = form.get('password');\n  const regexPassword = /(^[a-zA-Z%0-9{_%]{2,29}$|^$)/;\n  const confirmPassword = form.get('confirm_password');\n  try {\n    // VALIDATE TITLE AD\n    await Promise.all([(0,src_scripts_validators_validateLength__WEBPACK_IMPORTED_MODULE_1__.validateMinLength)(title, 3), (0,src_scripts_validators_validateLength__WEBPACK_IMPORTED_MODULE_1__.validateMaxLength)(title, 30), (0,src_scripts_validators_validateRegex__WEBPACK_IMPORTED_MODULE_2__.validateRegex)(password, regexPassword)]);\n  } catch (err) {\n    const fieldHTML = currentTarget.querySelector('input[name=\"password\"]');\n    (0,src_adboard_scripts_services_taskGetErrorContent__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(fieldHTML, err);\n    return;\n  }\n  if (confirmPassword || (typeof form.get('confirm_password')).includes(\"string\") && form.get('confirm_password').length == 0) {\n    // CHECK VALIDITY CONFIRM PASSWORD ;\n    if (confirmPassword.trim() !== password.trim()) {\n      const fieldHTML = currentTarget.querySelector('input[name=\"confirm_password\"]');\n      const err = new Error(\"err: Check the passwords.\");\n      (0,src_adboard_scripts_services_taskGetErrorContent__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(fieldHTML, err);\n      return;\n    }\n  }\n\n  // REGISTER USER\n  const templeteApi = pathname.includes(\"login\") ? \"/api/v1/users/index/0/login_user/\" : '/api/v1/users/index/';\n  // REGISTER USER\n  const url = new URL(templeteApi, _ENV__WEBPACK_IMPORTED_MODULE_3__.URL_HOST_FOR_API);\n  try {\n    const response = await fetch(url, body_);\n    if (!response.ok || response.status > 201) {\n      console.warn(\"[handlerFormUsers/handlerRegisterForm.ts:handlerUserForm]: From server received on invalid response.: \".concat(response.statusText));\n      currentTarget.querySelector(\".invalid\");\n      const err = new Error(\"[handlerFormUsers/handlerRegisterForm.ts::handlerUserForm]: From server received on invalid response. \".concat(response.statusText));\n      (0,src_adboard_scripts_services_taskGetErrorContent__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(currentTarget, err);\n      return;\n    }\n    const data = await response.json();\n    // CHANGE LOCATION\n    if (pathname.includes(\"register\")) {\n      setTimeout(() => window.location.pathname = \"/users/login/\", 200);\n    } else {\n      Array.from(data[\"data\"]).forEach(elementtoken => {\n        /**\r\n         Here. Reseive the the token_access and token_refresh and set in the cookie\r\n         */\n        // console.log(`data ${elementtoken}: `, data[elementtoken]);\n        if (Object.keys(elementtoken).includes(\"token_access\")) {\n          const k = \"token_access\";\n          const v = Object(elementtoken)[k];\n          const keyLifeTime = Object.keys(elementtoken)[1];\n          const liveTime = Math.round(parseFloat(Object(elementtoken)[keyLifeTime]));\n          (0,src_scripts_cookies_setCookies__WEBPACK_IMPORTED_MODULE_4__.setSessionIdInCookie)(k, v, String(liveTime));\n        } else {\n          const k = \"token_refresh\";\n          const v = Object(elementtoken)[k];\n          const keyLifeTime = Object.keys(elementtoken)[1];\n          const liveTime = Math.round(Object(elementtoken)[keyLifeTime]);\n          (0,src_scripts_cookies_setCookies__WEBPACK_IMPORTED_MODULE_4__.setSessionIdInCookie)(k, v, String(liveTime));\n          window.location.pathname = \"/\";\n        }\n      });\n    }\n  } catch (error) {\n    console.error(\"USER FORM ERROR: \", error.message);\n    throw new Error(\"USER FORM ERROR: \".concat(error));\n  }\n}\n;\n\n//# sourceURL=webpack://ads/./src/adboard/scripts/handlers/handlerFormUsers/handlerRegisterForm.ts?");
